...
// Calculate room usage counts
$roomUsage = [];
foreach ($bookings as $booking) {
    if (!isset($roomUsage[$booking['room_name']])) {
        $roomUsage[$booking['room_name']] = 0;
    }
    $roomUsage[$booking['room_name']]++;
}
?>
  ...
  <thead>
    ...
    <tbody>
       <?php if (!empty($roomUsage)): ?>
           <?php foreach ($roomUsage as $roomName => $count): ?>
                <tr>
